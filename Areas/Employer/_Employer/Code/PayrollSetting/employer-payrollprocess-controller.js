    ...
    function ($scope, httpService, httpCommonService) {
                ...
                httpService.httpFetchData(req)
                    .then((res) => {
                        if (res.status == 200) {
                            ...
                            // and employerallowanceBenefitInKind = false 
                            ...
                            if (PayrollAllowancenDeduction.length > 0) {
                                ...
                                for (let i = 0; i < PayrollAllowancenDeduction.length; i++) {
                                    $scope.AllowanceMaster.push({
                                        ...
                                        employerallowanceProrate: PayrollAllowancenDeduction[i].employerallowanceProrate,
                                        ...
                                        employerallowanceBenefitInKind: PayrollAllowancenDeduction[i].employerallowanceBenefitInKind,
                                        employerallowanceAdditionalRemuneration: PayrollAllowancenDeduction[i].employerallowanceAdditionalRemuneration,
                                        isLoanRecord: false
                                    });
                                }
                            }
                            ...
                            if (PayrollLoan.length > 0) {
                                for (let i = 0; i < PayrollLoan.length; i++) {
                                    $scope.AllowanceMaster.push({
                                        ...
                                        employerallowanceProrate: false,
                                        ...
                                        employerallowanceAdditionalRemuneration: false,
                                        isLoanRecord: true
                                    })
                                }
                            }
        ...
        $scope.onClick_InsertAllowance = () => {
            ...
            try {
                ...
                $scope.AllowanceMaster.push({
                    ...
                    employerallowanceProrate: Allowance[0].employerallowanceProrate,
                    ...
                    employerallowanceBenefitInKind: Allowance[0].employerallowanceBenefitInKind,
                    employerallowanceAdditionalRemuneration: Allowance[0].employerallowanceAdditionalRemuneration,
                    isLoanRecord: false
                });
                insertMsg();
                $scope.onLoad_ClearAllowance();
        ...
        $scope.onClick_SalaryRecalculation = (x) => {
            try {
                ...
                let _month = moment($scope._dateClicked).format("MM");
                let _year = moment($scope._dateClicked).format("YYYY");
                ...
                let masterTotalNPL = masterDaysCalculate + masterHoursCalculate;
                ...
                if ($scope.AllowanceMaster.length > 0) {
                    for (let i = 0; i < $scope.AllowanceMaster.length; i++) {
                        if ($scope.AllowanceMaster[i].isLoanRecord == false && $scope.AllowanceMaster[i].employerallowanceBenefitInKind.data[0] == 0) {
                ...
                if ($scope.AllowanceMaster.length > 0) {
                    for (let i = 0; i < $scope.AllowanceMaster.length; i++) {
                        if ($scope.AllowanceMaster[i].isLoanRecord == true && $scope.AllowanceMaster[i].employerallowanceBenefitInKind.data[0] == 0) {
                ...
                if ($scope._statutoryManualUpdate == true) {
                    ...
                    let req = {
                        ...
                        data: {
                            ...
                            "AllowanceMaster": JSON.stringify($scope.AllowanceMaster),
                            "overtimeMaster": JSON.stringify(Overtime),
                            "shiftMaster": JSON.stringify(Shift),
                            "addPayMaster": JSON.stringify(AdditionalPay),
                            "_totalDaysPayrollDate": _totalDaysPayrollDate,
                            "masterTotalNPL": masterTotalNPL
                        }
                    };
                    ...
                    httpService.httpFetchData(req)
                        .then((res) => {
                            ...
                            // from here
                            $scope.pcbEmployee = result.PCBERate;
