    ...
    function ($rootScope, $scope, $http) {
        ...
        $scope.onClick_Signout = () => {
            try {
                ...
                localStorage.removeItem("_izemEmployerEmail");
                localStorage.removeItem("_izemEmployerManagerEmail");
                ...
                localStorage.removeItem("_izemMemberId");
                localStorage.removeItem("_employeeType");
                localStorage.removeItem("_employerbranchId");
        ...
        onLoad_Rights = () => {
            try {
                ...
                let employeeType = localStorage.getItem("_employeeType");
                ...
                if (employeeType == "branch" && userRole != 'userRole') {
                    $scope.redirectMember = true;
