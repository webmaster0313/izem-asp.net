...
app.controller("member-leaveapplication-controller", ['$scope', 'httpService', 'httpCommonService', '$http',
    function ($scope, httpService, httpCommonService, $http) {
        ...
        //. Pending
        $scope.pendingEmail = (_izemEmployerEmail, _selectedEmployeeEmail, _izemLoginName, _selectedEmployeeName, _employeeleaveapplicationLeaveStatus,
            ...
            try {
                ...
                $http({
                    method: "POST",
                    url: "/member/LeaveSetting/send_EmailForPendingLeaveApplication",
                    responseType: "blob",
                    data: {
                        "employerEmail": _izemEmployerEmail,
                                        ...
                                        httpService.httpFetchData(req)
                                            .then((res) => {
                                                if (res.status == 200) {
                                                    ...
                                                    $scope.pendingEmail($scope._izemEmployerEmail, $scope._selectedEmployeeManagerEmail, $scope._izemLoginName, $scope._selectedEmployeeName,
                ...
                if (employeeData.length > 0) {
                    ...
                    if (employeeData[0].employeeIsFixJoining.data[0] == "0") {
                        ...
                        if ($scope._selectedemployeeManagerId != "") {
                            ...
                            $scope._selectedEmployeeManagerEmail = $scope._izemEmployerEmail;
                        }
