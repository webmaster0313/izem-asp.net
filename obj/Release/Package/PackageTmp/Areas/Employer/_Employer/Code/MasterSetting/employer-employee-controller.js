                ...
                httpCommonService.fill_employee()
                    .then((res) => {
                        if (res.status == 200) {
                            ...
                            $scope.fill_employeeManager = res.data;
                        }
                    }, (err) => {
                        console.log(err);
                    })
        ...
        $scope.onClick_SubmitEmployee = () => {
            try {
                ...
                let pera = {
                    ...
                    "employeeIsManualAttendance": employeeIsManualAttendance, "employeeIsMultipleLogin": employeeIsMultipleLogin
                }
                ...
                httpService.httpFetchData(req)
                    .then((res) => {
                        if (res.status == 200) {
                            ...
                            $scope.employeeManagerId = res.data.employeeManagerId == 0 ? "" : res.data.employeeManagerId;
